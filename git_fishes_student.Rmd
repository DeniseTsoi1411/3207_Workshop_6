...
library(png)
img1 <- readPNG("./Files/pics/acantho.png")
raster1 <- as.raster(img1)
...
# anova_data <- aov(mean ~ treatment + species, data = data_g)
# summary(anova_data)
# 
# t.test(treat, control, var.equal = T )
# data_n

mod1 <- lm(activity ~ treatment * species, data = data_n)
anova(mod1)
summary(mod1)
